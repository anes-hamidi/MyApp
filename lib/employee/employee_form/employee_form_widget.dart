...
import 'employee_form_model.dart';
export 'employee_form_model.dart';
...
class _EmployeeFormWidgetState extends State<EmployeeFormWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeFormModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Salary',
                        hintText: 'Enter worker\'s salary',
                        hintStyle: FlutterFlowTheme.of(context).bodyLarge,
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                            color: FlutterFlowTheme.of(context).primary,
                      ...
                      onPressed: () async {
                        await UsersRecord.collection
                            ...
                            .set(createUsersRecordData(
                              ...
                              rool: _model.textController3.text,
                              salery: int.tryParse(_model.textController4.text),
                            ));
                        setState(() {
